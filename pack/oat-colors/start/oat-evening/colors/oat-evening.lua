-- oat-evening ~ Neovim Colorscheme
--
-- Based on the classic 'evening' theme from Vim.
...
vim.g.colors_name = 'oat-evening'

local M = {}

-- Color Palette
-- Original evening had a dark blue/grey background. We're using #000000.
