-- oat-zellner ~ Neovim Colorscheme
--
-- Based on the classic 'zellner' theme from Vim.
...
vim.g.colors_name = 'oat-zellner'

local M = {}

-- Color Palette
-- Original zellner had a light grey background. We're using #000000.
-- Colors have been inverted and brightened for better contrast.
M.palette = {
  -- Base
  black      = '#000000',
  white      = '#ffffff',
