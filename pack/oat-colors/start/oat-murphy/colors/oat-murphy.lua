-- oat-murphy ~ Neovim Colorscheme
--
-- Based on the classic 'murphy' theme from Vim.
...
vim.g.colors_name = 'oat-murphy'

local M = {}

-- Color Palette
-- Original murphy had a dark navy background. We're using #000000.
...
M.highlights = {
  -- Base
  Normal            = { fg = M.palette.light_grey, bg = M.palette.black },
  ...
  FzfLuaTitle           = { fg = M.palette.green, bold = true },
