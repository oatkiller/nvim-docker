-- oat-slate ~ Neovim Colorscheme
--
-- Based on the classic 'slate' theme from Vim.
...
vim.g.colors_name = 'oat-slate'

local M = {}

-- Color Palette
-- Original slate had a dark grey background. We're using #000000.
...
M.highlights = {
  ...
  TabLine           = { fg = M.palette.white, bg = M.palette.dark_grey },
  ...
  Pmenu             = { bg = M.palette.dark_grey, fg = M.palette.white },
